...
const Contect = () => {
  ...
  const onSubmit = (data) => {
    console.log(data);
    window.location.href = `mailto:nababratadeb3@gmail.com&body=Hi, My Name is ${data.full_name}. ${data.message} (${data.email})`;
  };
      ...
      <div className="container mx-auto">
          ...
          <div className="xl:w-3/5 lg:w-3/5 bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
            <form
              ...
              <div className="w-full mt-6">
                ...
                <button
                  type="submit"
                  className="focus:outline-none bg-indigo-900 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-3 text-sm leading-6">
                  Submit
                </button>
              </div>
            </form>
        ...
        <div className="flex mt-4 px-4 items-center justify-between flex-wrap gap-4">
          ...
          <p className="font-normal text-[14px] text-white opacity-50">
            ©Developed by Teach Team | E-Cell | UAE  . <br /> All rights
            reserved.
          </p>
