...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    <motion.div
      ...
      <TypingText title="| About Pet 2 Place" textStyles="text-center" />

      <motion.p
        variants={fadeIn("up", "tween", 0.2, 1)}
        className="mt-[8px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-white">
        <span className="font-extrabold text-white">Welcome to Pet 2 Place, </span>{" "}
        where passion meets pet care! We understand that your pets are not just animals; they are cherished members of your family. At [Your Company Name], we are dedicated to providing top-notch pet care services, innovative rental solutions, and quality pet products to enhance the well-being of your furry friends.
