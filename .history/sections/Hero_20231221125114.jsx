    ...
    <motion.div
      ...
      <div className="flex justify-center items-center flex-col relative z-10">
        ...
        <motion.div
          ...
          <h1 className={styles.heroHeading}>Pet 2 Place</h1>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        <video
          ...
          loop
          controls
          poster="https://res.cloudinary.com/driibhe5y/image/upload/v1703143239/group-pets-dog-cat-bird-rabbit_191971-22463.jpg_myykrj.jpg"
