  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    <motion.div
      ...
      <motion.p
        ...
        of Technology   that aims at manifesting the latent
        entrepreneurial spirit of the young students. Pet 2 Place aims at promoting
        the startup culture in   as well as North-East India. With
        various undergoing projects, few successful startups, a lot of failures,
        and the flagship
        <span className="font-extrabold text-white">
          'Carpediem E-Summit',
        </span>{" "}
        Pet 2 Place has transformed itself from a small community established by
